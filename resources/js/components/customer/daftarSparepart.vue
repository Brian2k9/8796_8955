  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/sparepart?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/spaarepart/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.spareparts = resp.data.data;
          app.sparepartsData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaSparepart){
          axios.delete('/8796_8955/public/api/sparepart/' + id)
          .then((resp) => {
            this.getResults();
