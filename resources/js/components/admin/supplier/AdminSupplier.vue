  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/suppliers?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/supplier/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.suppliers = resp.data.data;
          app.suppliersData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaSupplier){
          axios.delete('/8796_8955/public/api/supplier/' + id)
          .then((resp) => {
            this.getResults();
