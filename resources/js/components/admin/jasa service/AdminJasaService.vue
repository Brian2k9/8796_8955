  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/jasa_service?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/jasa_service/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.jasa_services = resp.data.data;
          app.jasaservicesData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaJasa){
          axios.delete('/8796_8955/public/api/jasa_service/' + id)
          .then((resp) => {
            this.getResults();
