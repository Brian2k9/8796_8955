...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/trans_penjualan/SPK/'+this.transId)
     .then((resp) => {
    ...
    methods: {
      ...
      getDetailTransJasa(){
        var app = this;
        axios.get('/8796_8955/public/api/trans_penjualan/detail_jasa' + '/all')
        .then(function(resp){
       ...
       getDetailTransSparepart(){
        var app = this;
        axios.get('/8796_8955/public/api/trans_penjualan/detail_spare' + '/all')
        .then(function(resp){
      ...
      getJasas(){
        var app = this;
        axios.get('/8796_8955/public/api/jasa_service' + '/all')
        .then(function(resp){
      ...
      getPegawais(){
        var app = this;
        axios.get('/8796_8955/public/api/pegawai' + '/all')
        .then(function(resp){
      ...
      getKendaraans(){
        var app = this;
        axios.get('/8796_8955/public/api/kendaraan' + '/all')
        .then(function(resp){
      ...
      getSpareparts(){
        var app = this;
        axios.get('/8796_8955/public/api/sparepart' + '/all')
        .then(function(resp){
      ...
      getPelanggans(){
        var app = this;
        axios.get('/8796_8955/public/api/pelanggan' + '/all')
        .then(function(resp){
