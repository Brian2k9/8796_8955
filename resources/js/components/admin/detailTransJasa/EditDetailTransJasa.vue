...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/trans_penjualan/detail_jasa/'+this.transJasaId)
     .then((resp) => {
    ...
    methods: {
      ...
      getTransaksiPenjualan(){
        var app = this;
        axios.get('/8796_8955/public/api/trans_penjualan' + '/all')
        .then(function(resp){
      ...
      saveForm(){
        ...
        axios.put('/8796_8955/public/api/trans_penjualan/detail_jasa/update/' + this.transJasaId ,newDetailTransJasa)
        .then((resp) => {
