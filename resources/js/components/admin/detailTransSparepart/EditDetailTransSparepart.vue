...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/trans_penjualan/detail_spare/'+this.transSparepartId)
     .then((resp) => {
    ...
    methods: {
      ...
      saveForm(){
        ...
        axios.put('/8796_8955/public/api/trans_penjualan/detail_spare/update/' + this.transSparepartId ,newDetailTransSparepart)
        .then((resp) => {
