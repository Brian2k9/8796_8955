  ...
  export default {
    ...
    methods: {
      getResults(){
        ...
        axios.get('/8796_8955/public/api/trans_penjualan/showDetailSparepart/'+this.detailTransSparepartId)
          .then((resp) => {
      ...
      deleteEntry(id,index){
          axios.delete('/8796_8955/public/api/trans_penjualan/detail_spare/' + id)
          .then((resp) => {
            this.getResults();
