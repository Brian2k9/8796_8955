...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/trans_pengadaan/'+this.transPengadaanId)
     .then((resp) => {
    ...
    methods: {
      ...
      getSuppliers(){
        var app = this;
        axios.get('/8796_8955/public/api/supplier' + '/all')
        .then(function(resp){
      ...
      getCabangs(){
        var app = this;
        axios.get('/8796_8955/public/api/cabang' + '/all')
        .then(function(resp){
      ...
      saveForm(){
        ...
        axios.put('/8796_8955/public/api/trans_pengadaan/konfirmasi/' + this.transPengadaanId ,newTransPengadaan)
        .then((resp) => {
