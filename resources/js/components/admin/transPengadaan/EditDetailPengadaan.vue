...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/detail_trans_pengadaan/'+this.detailtransPengadaanId)
     .then((resp) => {
    ...
    methods: {
      ...
      getTransPengadaan(){
        var app = this;
        axios.get('/8796_8955/public/api/trans_pengadaan' + '/all')
        .then(function(resp){
      ...
      saveForm(){
        ...
        axios.put('/8796_8955/public/api/detail_trans_pengadaan/update/' + this.detailtransPengadaanId ,newDetailTransPengadaan)
        .then((resp) => {
