  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/cabang?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/cabang/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.cabangs = resp.data.data;
          app.cabangsData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaCabang){
          axios.delete('/8796_8955/public/api/cabang/' + id)
          .then((resp) => {
            this.getResults();
