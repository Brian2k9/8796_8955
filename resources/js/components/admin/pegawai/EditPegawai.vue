...
<script>
  export default {
    ...
    mounted()  {
     ...
     axios.get('/8796_8955/public/api/pegawai/'+this.pegawaiId)
     .then((resp) => {
    ...
    methods: {
      ...
      getRoles(){
        var app = this;
        axios.get('/8796_8955/public/api/role' + '/all')
        .then(function(resp){
          app.roles = resp.data;
        })
        .catch(function(resp){
      ...
      saveForm(){
        ...
        axios.put('/8796_8955/public/api/pegawai/update/' + this.pegawaiId ,newPegawai)
        .then((resp) => {
