  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/pegawai?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/pegawai/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.pegawais = resp.data.data;
          app.pegawaisData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaPegawai){
          axios.delete('/8796_8955/public/api/pegawai/' + id)
          .then((resp) => {
            this.getResults();
