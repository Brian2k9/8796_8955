  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/pelanggan?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/pelanggan/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.pelanggans = resp.data.data;
          app.pelanggansData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaPelanggan){
          axios.delete('/8796_8955/public/api/pelanggan/' + id)
          .then((resp) => {
            this.getResults();
