  ...
  export default {
    ...
    methods: {
      getResults(page){
        ...
        axios.get('/8796_8955/public/api/role?page=' + page)
        .then(function(resp){
      ...
      getHasilPencarian(page){
        ...
        axios.get('/8796_8955/public/api/role/search?q='+app.pencarian+'&page=' + page)
        .then(function(resp){
          app.roles = resp.data.data;
          app.rolesData = resp.data;
          app.loading = false;
      ...
      deleteEntry(id,index,namaRole){
          axios.delete('/8796_8955/public/api/role/' + id)
          .then((resp) => {
            this.getResults();
