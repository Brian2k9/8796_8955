...
class reportController extends Controller
{
	...
	public function tahunan_perCabang() {
		...
		$tahun2016_cabang = $tahun2016->select('cabangs.alamat_cabang')->get();
		...
		$tahun2017_cabang = $tahun2017->select('cabangs.nama_cabang')->get();;
		...
		$tahun2018_cabang = $tahun2018->select('cabangs.nama_cabang')->get();;
